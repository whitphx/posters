...
- `lucide:*`: Interface and deployment icons by the Lucide contributors, rendered from Iconify data through Astro Icon. Iconify lists the [Lucide icon set](https://icon-sets.iconify.design/lucide/) as ISC licensed with no attribution required. [Astro Icon](https://www.astroicon.dev/) is MIT licensed, and its package retains the upstream license notice.
